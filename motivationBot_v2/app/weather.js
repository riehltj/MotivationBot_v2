...
//     document.querySelector('.weather-js').style.border = "orange 5px solid"

//     document.getElementById('city-js').innerHTML = city;
//     document.getElementById('temp').innerHTML = `${temp}°F`;
//     document.getElementById('icon').src = iconUrl
//     document.getElementById('icon').style.width = "25%";
...
// document.getElementById('city-js').addEventListener('click', getWeather)